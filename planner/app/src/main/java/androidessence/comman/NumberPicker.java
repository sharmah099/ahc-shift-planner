...
public class NumberPicker extends LinearLayout {
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        mSelectionDivider = ContextCompat.getDrawable(context, R.mipmap.np_numberpicker_selection_divider);
        ...
        mTextStyle = attributesArray.getInt(R.styleable.NumberPicker_np_textStyle, 0);
